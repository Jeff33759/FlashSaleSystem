...
public class FlashOrderService implements IOrderService {
     ...
     */
    @Override
    public InnerCommunicationDto createOrder(JsonNode param, MyContext context) throws MyException {
    ...
    @Override
    public InnerCommunicationDto finishOrder(JsonNode param, MyContext context) throws MyException {
